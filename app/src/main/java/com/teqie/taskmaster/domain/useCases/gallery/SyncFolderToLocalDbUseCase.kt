...
class SyncFolderToLocalDbUseCase @Inject constructor(private val galleryRepository: GalleryRepository) {
    operator  fun invoke(projectId: String): Flow<Resource<Unit>> {
        return galleryRepository.syncFoldersToLocal(projectId)
    }
}